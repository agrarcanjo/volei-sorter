...
const createTestPlayers = () => [
  {
    ...
    gender: 'masc',
    position: 'levantador',
    skills: { levantamento: 9, ataque: 5, defesa: 6, bloqueio: 5 },
  },
  {
    id: 2,
    name: 'Maria',
    gender: 'fem',
    position: 'ponta',
    skills: { levantamento: 3, ataque: 8, defesa: 7, bloqueio: 6 },
  },
  {
    id: 3,
    name: 'Pedro',
    gender: 'masc',
    position: 'oposto',
    skills: { levantamento: 2, ataque: 9, defesa: 5, bloqueio: 8 },
  },
  {
    id: 4,
    name: 'Ana',
    gender: 'fem',
    position: 'central',
    skills: { levantamento: 1, ataque: 6, defesa: 9, bloqueio: 9 },
  },
  {
    id: 5,
    name: 'Carlos',
    gender: 'masc',
    position: 'libero',
    skills: { levantamento: 2, ataque: 3, defesa: 10, bloqueio: 2 },
  },
  {
    id: 6,
    name: 'Beatriz',
    gender: 'fem',
    position: 'levantador',
    skills: { levantamento: 8, ataque: 4, defesa: 5, bloqueio: 4 },
  },
  {
    id: 7,
    name: 'Bruno',
    gender: 'masc',
    position: 'ponta',
    skills: { levantamento: 3, ataque: 7, defesa: 6, bloqueio: 5 },
  },
  {
    id: 8,
    name: 'Sofia',
    gender: 'fem',
    position: 'oposto',
    skills: { levantamento: 1, ataque: 8, defesa: 4, bloqueio: 7 },
  },
  {
    id: 9,
    name: 'Ricardo',
    gender: 'masc',
    position: 'central',
    skills: { levantamento: 2, ataque: 5, defesa: 8, bloqueio: 8 },
  },
  {
    id: 10,
    name: 'Lucas',
    gender: 'masc',
    position: 'libero',
    skills: { levantamento: 3, ataque: 4, defesa: 9, bloqueio: 3 },
  },
  {
    id: 11,
    name: 'Juliana',
    gender: 'fem',
    position: 'ponta',
    skills: { levantamento: 2, ataque: 7, defesa: 5, bloqueio: 4 },
  },
  {
    id: 12,
    name: 'Felipe',
    gender: 'masc',
    position: 'oposto',
    skills: { levantamento: 1, ataque: 8, defesa: 3, bloqueio: 7 },
  },
];
